...
public class HistoryTileBackendFactory {
    ...
    public static IStateHistoryBackend createHistoryTreeBackendNewFile(String ssid,
            File stateFile, int providerVersion, long startTime, int nPixels, long[] resolutions, boolean isEveryIntervalContiguous) throws IOException {
        return new HistoryTileBackend(ssid, stateFile, providerVersion, startTime, nPixels, resolutions, isEveryIntervalContiguous);
    }
    ...
    public static IStateHistoryBackend createHistoryTreeBackendNewFile(String ssid, long startTime, long endTime, int providerVersion, File stateFile, boolean isEveryIntervalContiguous) throws IOException {
        ...
        return new HistoryTileBackend(ssid, stateFile, providerVersion, startTime, N_PIXELS, resolutions, isEveryIntervalContiguous);
    }
