...
public class HistoryTileConfig {
    ...
    private static final int STATIC_HEADER_SIZE = 4 * Integer.BYTES + Byte.BYTES;
    ...
    HistoryTileConfig(File stateFile, int providerVersion, long startTime, int nPixels, long[] resolutions, boolean isEveryIntervalContiguous) {
    ...
    public void writeHeader(FileChannel channel) {
        ...
        try {
            ...
            buffer.put((byte) (fIsEveryIntervalContiguous ? 1 : 0));
