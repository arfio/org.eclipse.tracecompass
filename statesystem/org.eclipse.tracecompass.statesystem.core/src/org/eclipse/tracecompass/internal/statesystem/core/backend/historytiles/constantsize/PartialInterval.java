...
public class PartialInterval {
    ...
    public PartialInterval(long start, Object value, int attribute) {
        fStart = start;
        fValue = value;
    ...
    public void writeStateValue(ByteBuffer buffer) {
        if (fValue != null) {
    ...
    public static Object readState(ByteBuffer buffer) throws IOException {
        Object value;
