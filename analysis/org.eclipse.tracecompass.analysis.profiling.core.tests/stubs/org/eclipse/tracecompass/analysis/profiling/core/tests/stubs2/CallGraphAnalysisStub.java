 ...
 * from the {@link InstrumentedCallStackAnalysis} base class. It allows to
 * specify the callstack analysis from a state system and the patterns to use
 * for each grouping level of the callstack.
 *
...
public class CallGraphAnalysisStub extends CallGraphAnalysis {
    ...
    private static class CSAnalysis extends InstrumentedCallStackAnalysis {
        ...
        public synchronized @Nullable CallStackSeries getCallStackSeries() {
            List<String[]> patterns = fPatterns;
